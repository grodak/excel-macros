...
With Sheets("Sheet1").ListObjects.Add(SourceType:=0, Source:=Array( _
    "OLEDB;Provider=Microsoft.ACE.OLEDB.12.0;Password="""";User ID=Admin;Data Source=Z:\Project Plans\COD Retiree VEBA\Retirement System Pension Deductions\RHTPenDeductions.mdb;Mode=ReadWrite;Extended Properties="""";Jet OLE" _
    , _
    ...
    .SourceDataFile = "Z:\Project Plans\COD Retiree VEBA\Retirement System Pension Deductions\RHTPenDeductions.mdb"
